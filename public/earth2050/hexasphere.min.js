...
function Planet(e, t, a, i) {
    ...
    function u(t, a) {
        ...
        c.deactivateHexagon(), e.controls.autoRotate = !1, c.location_current = t, O = t, t.briefs = PlanetData.hasLocationAnyBriefs(O, !0), t.briefs_text = PlanetData.hasLocationAnyBriefTexts(O, !0), t.works_list = PlanetData.getWorkList(O, !0), t.more = PlanetData.getMoreText(O, !0);
        var r = [t];
    ...
    function h(t) {
        ...
        a = "brief" === i.type ? i.brief_id : langUrl + "locations/" + PlanetData.YEAR_ID + "/" + t.location_id, c.state = c.ANIMATED, e.controls.detach(), f.style.cursor = "default", c.deactivateHexagon(), c.commentToggle(!1), U.lookAt(t.position);
    ...
    this.update = function() {
        if (R = v.position.distanceToSquared(THREE.Vector3.ZERO) - 100, w.lookAt(v.getWorldPosition()), c.static_container.updateMatrix(), this.grid_shpere.rotation.y += 5e-4, this.orbits)
    ...
    var A = new THREE.Vector2(-2, -2),
        H = A.clone(),
        b = 0,
        M = new THREE.Sphere(c.container.position.clone(), m),
...
function Hexagon(e) {
    var t = new THREE.Color(16777215),
        a = (new THREE.Color(5275216), Utils.createHexagon(.5)),
        i = a.material;
...
function PlanetPointed(e) {
    ...
    for (var a = [], i = 0; i < 2; i++) {
        ...
        r.color = new THREE.Color(3257463), r.map = t, r.depthWrite = !1, r.transparent = !0, r.opacity = 0, r.blending = THREE.AdditiveBlending;
        var n = i / 2;
    ...
    this.init = function(t) {
        ...
        for (var T, x, R, A, H = Utils.createHexagon(.12, !1, s, .025), b = new THREE.Geometry, M = .01, P = (Math.PI, !1), y = .5 - Math.PI; y < -.6; y += .04) {
            R = .5 * Math.cos(y) + .5, P = !P, M = Math.abs(.01 / Math.sin(R * Math.PI)), T = Math.floor(1 / M);
            for (var S = 0; S < T; S++) x = .5 + (T / 2 - S - (P ? .5 : 0)) * M, A = R, Math.random() > .25 || l.isLandByUV(x, A) || l.isLandByUV(x - .02, A) || l.isLandByUV(x + .02, A) || l.isLandByUV(x, A - .02) || l.isLandByUV(x, A + .02) || (Utils.setFromSpherical(e.radius * (.97 - .01 * Math.random()), x, A, H.position), H.lookAt(THREE.Vector3.ZERO), H.updateMatrix(), H.updateMatrixWorld(), b.merge(H.geometry, H.matrixWorld))
        }
...
function PlanetCommentPopup(e) {
    var t, a = !1,
        i = window.PLANET,
        r = $("<div class='planet-comment-line'>").appendTo(e).hide(),
        n = $("<div class='planet-comment'>").appendTo(e).hide(),
        o = $("<div class='planet-comment-text'>").appendTo(n),
        s = i.main.camera,
...
function ProjectiveImage(e, t) {
    ...
    function(e) {
        function t() {
            var e = window.innerWidth > 1e3 ? window.innerWidth - 302 : window.innerWidth,
...
Planet.prototype.getClosestLocation = function(e) {
    ...
    o.material.opacity = .3, n.load(PlanetData.textures_path + e, function(e, a) {
        var i = new THREE.MeshBasicMaterial({
    ...
    d.material = l, e.container.add(d), d.rotation.y = Math.PI, d.updateMatrix(), this.show = function(e, i) {
        ...
        //     var n = r.contour_url;
        r.contour_texture = [t("/assets/earth/contour1_1.png"), t("/assets/earth/contour2_1.png")]
            // }
        o.map = r.contour_texture[0], o.map.generateMipalphaMaps = !1, o.map.magFilter = THREE.LinearFilter, o.map.minFilter = THREE.LinearFilter, o.needsUpdate = !0, l.map = r.contour_texture[1], l.map.generateMipalphaMaps = !1, l.map.magFilter = THREE.LinearFilter, l.map.minFilter = THREE.LinearFilter, l.needsUpdate = !0,
            a(s, i), a(d, i)
    }, this.hide = function(e) {
        i(s, e), i(d, e)
    }
...
var PlanetData = function() {
    ...
    this.textures_path = "/assets/earth/", this.YEAR = null, this.YEAR_ID = null, this.years = {
        ...
        2050: {
            earth_url: this.textures_path + "earth_1.png",
            contour_url: ["/assets/earth/" + "contour1_1.png", "/assets/earth/" + "contour2_1.png"],
            min_locations: 10
        }
    }, this.year_ids = [];
